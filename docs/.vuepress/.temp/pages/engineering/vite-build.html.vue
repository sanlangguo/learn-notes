<template><div><h2 id="记录-vite4-x-vue3-打包优化" tabindex="-1"><a class="header-anchor" href="#记录-vite4-x-vue3-打包优化" aria-hidden="true">#</a> 记录 vite4.x vue3 打包优化</h2>
<h3 id="打包之前我们先梳理下vite-打包从哪些方面入手" tabindex="-1"><a class="header-anchor" href="#打包之前我们先梳理下vite-打包从哪些方面入手" aria-hidden="true">#</a> 打包之前我们先梳理下vite 打包从哪些方面入手</h3>
<ol>
<li>先对打包体积进行分析</li>
<li>根据包体积分析的结果，做相应的优化，之后我们以下几个方面入手：</li>
</ol>
<ul>
<li>图片压缩</li>
<li>gzip代码压缩</li>
...
<h3 id="包分析" tabindex="-1"><a class="header-anchor" href="#包分析" aria-hidden="true">#</a> 包分析</h3>
<ul>
<li>安装与使用</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token number">1.</span>安装 
...
<li>包分析
<img src="/img/vite-build.jpg" alt="vite打包分析"></li>
</ul>
<h3 id="gzip代码压缩" tabindex="-1"><a class="header-anchor" href="#gzip代码压缩" aria-hidden="true">#</a> gzip代码压缩</h3>
<ul>
<li>安装与使用</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token number">1.</span>安装 
...
<p>开启 gzip 需要同时确保 Web 服务器已经开启了对应的 gzip 支持</p>
<ul>
<li>以 nginx 为例：</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="esbuild-压缩模式下删除-console-log-和-debugger" tabindex="-1"><a class="header-anchor" href="#esbuild-压缩模式下删除-console-log-和-debugger" aria-hidden="true">#</a> esbuild 压缩模式下删除 console.log 和 debugger</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="cdn-加速" tabindex="-1"><a class="header-anchor" href="#cdn-加速" aria-hidden="true">#</a> CDN 加速</h3>
<p>内容分发网络（CDN）是一种通过将内容分发到离用户最近的服务器来提高网络请求响应速度的技术。它还可以通过减少应用程序打包的文件大小、利用浏览器缓存以及长期缓存不变的文件来优化性能。请注意，在学习讨论中，不建议使用第三方CDN。</p>
<ul>
<li>安装与使用</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token number">1.</span>安装 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="按需导入" tabindex="-1"><a class="header-anchor" href="#按需导入" aria-hidden="true">#</a> 按需导入</h3>
<ul>
<li>例如 lodash-es (其实lodash-es 是 lodash 的 es modules 版本 ，是着具备 ES6 模块化的版本，体积小，而lodash是common.js版本)</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> cloneDeep <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'lodash-es'</span><span class="token punctuation">;</span> <span class="token comment">// 你将会把引入cloneDeep引入到项目</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="代码分割策略" tabindex="-1"><a class="header-anchor" href="#代码分割策略" aria-hidden="true">#</a> 代码分割策略</h3>
<ol>
<li>vite2.9 之后更细粒度地控制代码分割策略，就得使用 manualChunks 配置，使用方式大概如下</li>
</ol>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token function">defineConfig</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
...
<li>使用 vite-plugin-chunk-split 插件</li>
</ol>
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a href="https://github.com/sanyuan0704/vite-plugin-chunk-split/blob/HEAD/README-CN.md#vite-plugin-chunk-split" target="_blank" rel="noopener noreferrer">更多配置参考github<ExternalLinkIcon/></a></p>
</div></template>
