<template><div><h2 id="_10-作用域链和闭包-代码中出现相同的变量-javascript-引擎是如何选择的" tabindex="-1"><a class="header-anchor" href="#_10-作用域链和闭包-代码中出现相同的变量-javascript-引擎是如何选择的" aria-hidden="true">#</a> 10-作用域链和闭包：代码中出现相同的变量，JavaScript 引擎是如何选择的？</h2>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">createCounter</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<p><a href="https://time.geekbang.com/column/intro/100033601" target="_blank" rel="noopener noreferrer">极客浏览器工作原理与实践学习笔记<ExternalLinkIcon/></a>。</p>
</div></template>
