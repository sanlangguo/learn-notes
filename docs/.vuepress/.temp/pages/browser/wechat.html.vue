<template><div><h3 id="微信公众号开发之监听返回事件" tabindex="-1"><a class="header-anchor" href="#微信公众号开发之监听返回事件" aria-hidden="true">#</a> 微信公众号开发之监听返回事件</h3>
<ul>
<li>项目中经常会遇到，用户填写表单之类的内容，填了一部分之后，可能会返回上一页，此时需要给用户一个提示，这就需要监听微信浏览器的返回事件，直接上代码</li>
</ul>
