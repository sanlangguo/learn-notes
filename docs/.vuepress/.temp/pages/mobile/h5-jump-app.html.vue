<template><div><h3 id="h5-跳转应用市场" tabindex="-1"><a class="header-anchor" href="#h5-跳转应用市场" aria-hidden="true">#</a> H5 跳转应用市场</h3>
<p>只跳转到应用市场,这种场景是最简单容易实现的</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>    <span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token string">'and'</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="h5-跳转-app-原理" tabindex="-1"><a class="header-anchor" href="#h5-跳转-app-原理" aria-hidden="true">#</a> H5 跳转 APP 原理</h3>
<p>首先，不管 iOS 还是 Android，浏览器都不可能预知本地是否安装了某个 APP 的。或者更严谨地说，我们不能通过浏览器来预知本地是否安装。其次，本质上浏览器是通过 URL scheme 打开 APP，一个 APP 可以设置一个或多个打开自己的 URL scheme。比如，Twitter 就注册自己能被「twitter://」打开。</p>
<h3 id="针对-h5-跳转安卓-app-指定页面" tabindex="-1"><a class="header-anchor" href="#针对-h5-跳转安卓-app-指定页面" aria-hidden="true">#</a> 针对 H5 跳转安卓 APP 指定页面</h3>
...
<p>sharesdk 是 ios 借助第三方平台 (mob) ，通过第三方接受 H5 传的参数，来进行页面跳转处理</p>
