...
const pagesData$1 = {
  ...
  "v-4362318d": () => import(
    ...
    "./assets/v2-v3.html-9f35ff74.mjs"
  ).then(({ data }) => data),
  // path: /vue/vue.html
  "v-13c9aef5": () => import(
